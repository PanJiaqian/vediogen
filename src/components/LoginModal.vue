        ...
        <div class="social-login">
          <button class="social-btn wechat-btn" @click="handleWechatLogin">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <path d="M23.759 11.336c0-3.676-3.28-6.65-7.32-6.65-4.041 0-7.32 2.974-7.32 6.65 0 3.675 3.279 6.65 7.32 6.65.784 0 1.551-.115 2.268-.334a.715.715 0 0 1 .593.081l1.579.922a.264.264 0 0 0 .138.044c.134 0 .24-.111.24-.248 0-.06-.024-.115-.04-.176l-.324-1.227a.487.487 0 0 1 .177-.551c1.516-1.109 2.489-2.764 2.489-4.611z"/>
            </svg>
          </button>
