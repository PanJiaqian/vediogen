...
export default {
  ...
  methods: {
    ...
    initNotificationsWebSocket() {
      ...
      const candidates = [
        `wss://creator.nexafeed.cn:1790/ws/notification?token=${t}`,
        `wss://creator.nexafeed.cn:1790/ws/notification?${t}`,
        `wss://creator.nexafeed.cn:1790/ws/notification?token-${t}`,
        `wss://creator.nexafeed.cn:1790/notification/ws?token=${t}`
