...
const MOCK_ASSETS = [
  // 实拍素材 (10条)
  { id: '1', title: '街头采访录像', thumbnail: 'https://images.unsplash.com/photo-1515630278258-407f66498911?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '真实的街头采访录像，适合做纪录片素材。', format: 'MP4', size: '124MB' },
  ...
  { id: '11', title: '雨天街道行车', thumbnail: 'https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '雨夜驾车的第一视角素材。', format: 'MP4', size: '250MB' },
  { id: '12', title: '海边日出延时', thumbnail: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '海边日出的绝美延时摄影。', format: 'MP4', size: '412MB' },
  { id: '13', title: '咖啡馆白噪音场景', thumbnail: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '安静的咖啡馆午后实拍。', format: 'MP4', size: '300MB' },
  { id: '14', title: '森林徒步记录', thumbnail: 'https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '第一视角森林徒步真实记录。', format: 'MP4', size: '510MB' },
  { id: '15', title: '繁忙的十字路口', thumbnail: 'https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '大城市繁忙十字路口的俯拍。', format: 'MP4', size: '180MB' },
  { id: '16', title: '厨房烹饪过程', thumbnail: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '煎牛排的特写镜头实拍。', format: 'MP4', size: '95MB' },
  { id: '17', title: '宠物猫玩耍', thumbnail: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&w=300&q=80', type: 'personal', category: '实拍素材', themeDescription: '小猫玩毛线球的可爱瞬间。', format: 'MP4', size: '60MB' },
  { id: '18', title: '烟花秀实况', thumbnail: 'https://images.unsplash.com/photo-1498931299472-f7a63a5a1cfa?auto=format&fit=crop&w=300&q=80', type: 'public', category: '实拍素材', themeDescription: '节日烟花秀的高清实拍。', format: 'MP4', size: '320MB' },

  // 网络素材 (10条)
  { id: '2', title: '星空背景视频', thumbnail: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '璀璨的银河系星空视频，适合科幻题材。', format: 'MP4', size: '53.1MB' },
  { id: '21', title: '故障艺术转场', thumbnail: 'https://images.unsplash.com/photo-1604871000636-074fa5117945?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '赛博朋克风格的故障转场特效。', format: 'MP4', size: '12MB' },
  { id: '22', title: '极简白色光效', thumbnail: 'https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '干净的白色光斑漏光素材。', format: 'MP4', size: '45MB' },
  { id: '23', title: '复古胶片颗粒', thumbnail: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '模拟老电影的胶片颗粒噪点覆盖。', format: 'MP4', size: '88MB' },
  { id: '24', title: '炫酷流光线条', thumbnail: 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '科技感十足的动态流光线条。', format: 'MP4', size: '150MB' },
  { id: '25', title: '动态音波可视化', thumbnail: 'https://images.unsplash.com/photo-1614149162883-504ce4d13909?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '适合音乐频道的音频跳动波形。', format: 'MP4', size: '65MB' },
  { id: '26', title: '水墨晕染特效', thumbnail: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '国风中国画水墨散开转场。', format: 'MP4', size: '30MB' },
  { id: '27', title: '复古电视雪花', thumbnail: 'https://images.unsplash.com/photo-1595859702810-1845180f55eb?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: 'CRT老电视无信号雪花噪点。', format: 'MP4', size: '20MB' },
  { id: '28', title: '金色粒子飘散', thumbnail: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=300&q=80', type: 'public', category: '网络素材', themeDescription: '唯美的金色粒子上升动画。', format: 'MP4', size: '110MB' },
  ...
  { id: '31', title: '股市大盘全景', thumbnail: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '华尔街股市大盘数据跳动画面。', format: 'MP4', size: '75MB' },
  { id: '32', title: '记者现场连线', thumbnail: 'https://images.unsplash.com/photo-1585829365295-ab7cd400c167?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '外景记者拿着话筒在风雨中连线报道。', format: 'MP4', size: '210MB' },
  { id: '33', title: '突发火灾远景', thumbnail: 'https://images.unsplash.com/photo-1602980068989-cb21ea54b036?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '城市远郊工厂突发火灾浓烟滚滚。', format: 'MP4', size: '140MB' },
  ...
  { id: '35', title: '抢险救灾现场', thumbnail: 'https://images.unsplash.com/photo-1516301389880-9a80b0fcb869?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '救援人员在洪灾前线搬运沙袋。', format: 'MP4', size: '300MB' },
  { id: '36', title: '新科技产品发布', thumbnail: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '某科技巨头发布会大屏幕PPT。', format: 'MP4', size: '185MB' },
  ...
  { id: '38', title: '火箭发射升空', thumbnail: 'https://images.unsplash.com/photo-1517976487492-5750f3195933?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '航天火箭点火升空的震撼镜头。', format: 'MP4', size: '450MB' },
  { id: '39', title: '市民排队核酸', thumbnail: 'https://images.unsplash.com/photo-1584483766114-2cea6facdf57?auto=format&fit=crop&w=300&q=80', type: 'public', category: '新闻素材', themeDescription: '疫情期间市民有序排队做检测。', format: 'MP4', size: '120MB' },
  ...
  { id: '41', title: '暗访黑作坊', thumbnail: 'https://images.unsplash.com/photo-1558227031-64ebcb320f78?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '针孔摄像头拍摄的食品黑作坊内幕。', format: 'MP4', size: '80MB' },
  { id: '42', title: '街头打架斗殴', thumbnail: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '路人手机摇晃拍摄的街角冲突。', format: 'MP4', size: '45MB' },
  { id: '43', title: '车祸行车记录仪', thumbnail: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '高速追尾瞬间的行车记录仪画面。', format: 'MP4', size: '120MB' },
  { id: '44', title: '高空抛物瞬间', thumbnail: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '监控摄像头拍下的高空抛物危险行为。', format: 'MP4', size: '30MB' },
  ...
  { id: '46', title: '粗暴执法录像', thumbnail: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '网友提供的安保人员粗暴对待商贩视频。', format: 'MP4', size: '66MB' },
  ...
  { id: '48', title: '电梯监控咸猪手', thumbnail: 'https://images.unsplash.com/photo-1506869640319-fea1a288fd71?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '电梯监控拍下的骚扰全过程。', format: 'MP4', size: '25MB' },
  { id: '49', title: '粉丝接机拥挤踩踏', thumbnail: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=300&q=80', type: 'public', category: '媒体爆料', themeDescription: '机场大量粉丝接机导致护栏倒塌。', format: 'MP4', size: '155MB' }
];
